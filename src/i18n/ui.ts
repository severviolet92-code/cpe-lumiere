...
export const ui = {
  fr: {
    ...
    nav: {
      ...
      about: 'Notre CPE',
      life: 'La vie au CPE',
      nutrition: 'Cuisine et nutrition',
      admission: 'Admission',
    ...
    about: {
      ...
      departments: {
        ...
        educators: 'Nos éducatrices et éducateurs',
        kitchen: 'La cuisine',
        specialists: 'Spécialistes et soutien',
      },
    },
    life: {
      title: 'La vie au CPE',
      day: 'Une journée type',
      groups: 'Nos groupes, un par âge',
      development: 'Grandir, un apprentissage à la fois',
      meals: 'Alimentation',
      naps: 'Sieste et repos',
      outdoor: 'Dehors, tous les jours',
      activities: 'Nos activités',
      safety: 'Santé et sécurité',
      nutritionCta: 'Découvrir la cuisine et les menus',
    },
    nutrition: {
      title: 'Cuisine et nutrition',
      philosophy: 'Notre philosophie',
      weeklyMenu: 'Une semaine au menu',
      day: 'Jour',
      snackAm: 'Collation du matin',
      lunch: 'Dîner',
      snackPm: 'Collation de l’après-midi',
      allergies: 'Allergies et intolérances',
      downloadMenu: 'Télécharger le menu (PDF)',
      photosEyebrow: 'Dans nos assiettes',
    },
    admission: {
      title: 'Admission',
      steps: 'Les étapes',
    ...
    careers: {
      ...
      qualifications: 'Qualifications recherchées',
      schedule: { full: 'Temps plein', part: 'Temps partiel', sub: 'Remplacement' },
      form: {
        title: 'Postuler',
        spontaneousTitle: 'Candidature spontanée',
        spontaneousLede:
          'Aucun poste ne correspond à votre profil en ce moment ? Envoyez-nous votre CV — nous gardons les candidatures pertinentes pour les prochaines ouvertures.',
        name: 'Votre nom',
        email: 'Votre courriel',
        phone: 'Téléphone (optionnel)',
        position: 'Poste visé',
        spontaneousOption: 'Candidature spontanée (aucun poste précis)',
        message: 'Message d’accompagnement (optionnel)',
        cv: 'Votre CV (PDF ou Word, 5 Mo max)',
        submit: 'Envoyer ma candidature',
        sending: 'Envoi en cours…',
        success: 'Merci ! Votre candidature a bien été reçue. Nous vous répondrons rapidement.',
        error: 'La candidature n’a pas pu être envoyée. Vérifiez le formulaire et réessayez.',
        fileTooLarge: 'Le fichier dépasse 5 Mo.',
        privacy:
          'Votre CV est transmis uniquement à la direction du CPE et supprimé une fois le recrutement terminé.',
      },
    },
    contact: {
      title: 'Nous joindre',
    ...
    portal: {
      ...
      demoNote: 'Comptes créés par l’administration seulement — aucune inscription libre.',
      tabPassword: 'Mot de passe',
      tabMagicLink: 'Lien magique',
      magicLinkLede: 'Recevez un lien de connexion par courriel — aucun mot de passe à retenir.',
      magicLinkSend: 'Envoyer le lien',
      magicLinkSent: 'Si ce courriel correspond à un compte, un lien de connexion vient d’être envoyé. Vérifiez votre boîte de réception (le lien expire dans 15 minutes).',
      magicLinkVerifying: 'Connexion en cours…',
      magicLinkError: 'Ce lien est invalide ou a expiré. Demandez-en un nouveau ci-dessous.',
      magicLinkRetry: 'Redemander un lien',
      hello: 'Bonjour',
      ...
      photosTitle: 'Photos',
      photosLede:
        'Les souvenirs partagés avec votre famille — photos de la vie du CPE et des groupes de votre enfant.',
  ...
  en: {
    ...
    life: {
      ...
      day: 'A typical day',
      groups: 'Our groups, one per age',
      development: 'Growing, one discovery at a time',
      meals: 'Meals',
      naps: 'Naps & rest',
      outdoor: 'Outside, every day',
      activities: 'Our activities',
      safety: 'Health & safety',
      nutritionCta: 'Discover the kitchen and menus',
    },
    nutrition: {
      title: 'Kitchen & nutrition',
      philosophy: 'Our philosophy',
      weeklyMenu: 'A week on the menu',
      day: 'Day',
    ...
    careers: {
      ...
      form: {
        ...
        spontaneousLede:
          'No posted position matches your profile right now? Send us your CV — we keep relevant applications on file for upcoming openings.',
        name: 'Your name',
        email: 'Your email',
        phone: 'Phone (optional)',
        position: 'Position',
        spontaneousOption: 'Spontaneous application (no specific position)',
        message: 'Cover message (optional)',
        cv: 'Your CV (PDF or Word, 5 MB max)',
        submit: 'Send my application',
        sending: 'Sending…',
        success: 'Thank you! Your application has been received. We will get back to you quickly.',
        error: 'Your application could not be sent. Check the form and try again.',
        fileTooLarge: 'The file exceeds 5 MB.',
        privacy:
          'Your CV goes only to the CPE’s direction and is deleted once the hiring round is over.',
      },
    },
    contact: {
      title: 'Contact us',
    ...
    portal: {
      ...
      demoNote: 'Accounts are created by the administration only — no self-registration.',
      tabPassword: 'Password',
      tabMagicLink: 'Magic link',
      magicLinkLede: 'Get a sign-in link by email — no password to remember.',
      magicLinkSend: 'Send the link',
      magicLinkSent: 'If that email matches an account, a sign-in link was just sent. Check your inbox (the link expires in 15 minutes).',
      magicLinkVerifying: 'Signing you in…',
      magicLinkError: 'This link is invalid or has expired. Request a new one below.',
      magicLinkRetry: 'Request a new link',
      hello: 'Hello',
      ...
      photosTitle: 'Photos',
      photosLede:
        'Memories shared with your family — photos of life at the CPE and your child’s groups.',
